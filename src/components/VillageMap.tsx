...
const BUILDINGS: Building[] = [
  ...
  { id: 'game', label: 'Games', image: '/village/game-rocket.png', x: 73, y: 31, width: 24, heightPct: 13.1, tilt: -5, accent: 'var(--lp-accent-compete)' },
  { id: 'messages', label: 'My Teacher', image: '/village/messages-teacherhome.png', x: 75, y: 17, width: 18, heightPct: 8.9, tilt: 4, accent: 'var(--lp-accent-training)' },
]
